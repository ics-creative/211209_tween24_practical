...
const i = e.exports.Tween24.serial(
  ...
  y = e.exports.Tween24.lagTotalEase(
    0.8,
  ...
  l = Array.from(document.querySelectorAll(".creative_bgText")).map((t) => {
    const o = t.querySelector(".firstText"),
      ...
      s = e.exports.Tween24.serial(
        ...
        e.exports.Tween24.tweenVelocity(o, p).y("-100%")
      ),
      n = e.exports.Tween24.serial(
        e.exports.Tween24.prop(r).y("100%"),
        e.exports.Tween24.tweenVelocity(r, p).y(0)
      );
    return e.exports.Tween24.loop(0, e.exports.Tween24.parallel(s, n));
  }),
    ...
    e.exports.Tween24.parallel(
      ...
      e.exports.Tween24.parallel(
        e.exports.Tween24.serial(
          e.exports.Tween24.parallel(y, g),
          e.exports.Tween24.parallel(_, u, l[0], l[1], v.delay(0.8))
        )
      ).delay(0.8)
    )
  );
